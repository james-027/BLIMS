                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <select name="analyticals[<?= $detail['trans_detail_id'] ?>]"
                                                        class="form-control form-control-sm analytical-select dynamic_dropdown"
                                                        data-target="<?= $detail['trans_detail_id'] ?>" required>
                                                        <option value="">Select Status</option>
                                                        <?php foreach($analyticals as $analytical): ?>
                                                        <option value="<?= $analytical->id ?>"
                                                            <?= $detail['pre_analytical_id'] == $analytical->id ? 'selected' : '' ?>>
                                                            <?= $analytical->process_name ?>
                                                        </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </td>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="confirmModalLabel">
                    <i class="fas fa-exclamation-circle mr-2"></i> Confirm Initial Prepration
                </h5>
            ...
            <div class="modal-body">
                ...
                <div id="dynamicStatusSummary" class="summary-container"></div>
