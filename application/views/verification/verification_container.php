                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <input type="hidden" name="test_status[<?= $detail['trans_detail_id'] ?>]"
                                                value="<?= $detail['test_status_id'] ?>">
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="text-center align-middle">
                                            <select name="reasons[<?= $detail['trans_detail_id']; ?>]"
                                                ...
                                                data-can-modify="<?= $can_modify ? 1 : 0 ?>"
                                                <?= $can_modify ? 'required' : '' ?>>
                                                ...
                                                <?php 
                                                $selected = (!empty($detail['latest_reason']) && $detail['latest_reason'] == $reason->reason_name) ? 'selected' : ''; 
                                            ?>
