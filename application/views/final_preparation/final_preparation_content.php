...
<div class="page-inner animated fadeInRightBig">
    ...
    <form method="post" action="<?=base_url($controller.'/submit_final_prep')?>" enctype="multipart/form-data"
        ...
        <div id="jobsContainer">
            ...
            <?php $this->load->view('final_preparation/final_preparation_container', ['jobs'=>$jobs, 'thColor'=>$thColor, 'display_status'=>$test_statuses]); ?>
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="confirmModalLabel">
                    <i class="fas fa-exclamation-circle mr-2"></i> Confirm Final Preparation
                </h5>
