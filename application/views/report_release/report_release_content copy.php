                            ...
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <div>
                                    <h5 class="mb-0">
                                        Job Order No:
                                        <span
                                            class="text-white font-weight-bold job_order_no"><?= $job['job_order_no'] ?></span>
                                    </h5>
                                    <div class="mt-1">
                                        Client: <span
                                            class="text-white font-weight-bold client_name"><?= $job['client_name'] ?>
                                    </div>
                                    <div class="mt-1">
                                        Nutritionist: <span
                                        ...
                                        <table class="table table-bordered table-hover table-striped mb-0 verication">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:110px;" title="Result Verification">Result
                                                        Verification
                                                    </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle lab_code"><?= $detail['lab_code'] ?? '-' ?>
                                                    </td>
                                                    <td class="align-middle sample_name">
                                                        <?= $detail['sample_name'] ?? '-' ?></td>
                                                    ...
                                                    <td class="align-middle"><?= $detail['release_ref_number'] ?? '-' ?>
                                                    </td>
