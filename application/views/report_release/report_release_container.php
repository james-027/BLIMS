             ...
             <div class="card-header bg-<?=$thColor?> <?=expColor($thColor)->fontColor?>">
                 <div class="d-flex justify-content-between align-items-center mb-1">
                     <div>
                         ...
                         <div class="mt-1">
                             Client: <span
                                 class="text-white font-weight-bold client_name"><?= $job['client_name'] ?></span>
                         </div>
                         <div class="mt-1">
                             Nutritionist: <span
                                 class="text-white font-weight-bold nutritionist_name"><?= $job['nutritionist_name'] ?></span>
                         </div>
                     </div>
