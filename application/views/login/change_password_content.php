        ...
        <div class="wrapper wrapper-login">
            <div class="container container-login animated fadeIn">
                <h3 class="text-center">
                    <?=SYS_FULL_NAME?><br><font class="text-primary font-weight-bold"><?=SYS_NAME?></font>
                    <br>
                    Change Password
                </h3>
                
                <form class="login-form" action="<?=base_url('login/reset-process')?>" method="POST" id="change-password-form">
                    ...
                    <div class="form-group form-floating-label">
                        <input name="new-password" type="password" class="form-control input-border-bottom" required>
                        <label for="email" class="placeholder">New Password</label>
                    </div>
                    <div class="form-group form-floating-label">
                        <input id="password" name="confirm-password" type="password" class="form-control input-border-bottom" required>
                    ...
                    <div class="form-action mb-3">
                        <button type="submit" class="btn btn-primary btn-rounded btn-login">Change</button>
                    </div>
                    <br>
