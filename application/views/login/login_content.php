    ...
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            <h3 class="text-center">
                <?=SYS_FULL_NAME?><br>
                <font class="text-primary font-weight-bold"><?=SYS_NAME?></font>

            </h3>
            <form class="login-form" action="<?=base_url('login/login-verification')?>" method="POST">
                <?php
                ...
                <div class="form-group form-floating-label">
                    <input id="email" name="email" type="text" class="form-control input-border-bottom email-login"
                        required>
                    <label for="email" class="placeholder">Email or Employee No. </label>
                </div>
                <div class="form-group form-floating-label">
                    <input id="password" name="password" type="password"
                        class="form-control input-border-bottom password-login" required>
...
<!-- 
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span class="small"><?=SYS_FOOTER?></span>
                    </div>
                </div>
            </footer>
        </div>
        ...
        <div class="container container-signup animated fadeIn">
            ...
            <form class="signup-form" action="<?= base_url('login/login_signup') ?>" method="POST">
                <div class="form-group form-floating-label">
