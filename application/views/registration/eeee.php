...
<div class="page-inner animated fadeInRightBig">
                                    ...
                                    <table class="table table-bordered table-hover table-striped mb-0 verification">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:200px;">Test Status</th>
    ...
    <?php if($isViewOnly): ?>
        <?php
            $statusText = 'Ongoing';
            $statusClass = 'badge-secondary'; // default when no status yet
    ...
    <?php else: ?>
        <select name="test_status[<?= $detail['trans_detail_id'] ?>]"
            ...
            data-target="#reason-<?= $detail['trans_detail_id'] ?>" required>
    ...
    <?php endif; ?>
                                                ...
                                                <td class="align-middle">
                                                    <?php if($isViewOnly): ?>
                                                        <span><?= htmlspecialchars($detail['existing_remark'] ?? '-', ENT_QUOTES, 'UTF-8') ?></span>
                                                    <?php else: ?>
